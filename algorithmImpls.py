...
def TVRecon(sinogram, geometry, reconstruction_space, lamda, niter=200):
...
def TVReconTime(sinogram, reconstruction_space, lamda_1, lamda_2, frames, thetas_all, angles_pr_frame, detector_partition):
    ...
    for t in range(frames):
        angle_partition = odl.uniform_partition(thetas_all[t], thetas_all[t+angles_pr_frame], angles_pr_frame)
...
def TVReconTimeCompression(sinogram, reconstruction_space, lamda_1, lamda_2, frames, thetas_all, angles_pr_frame, detector_partition, p=1.7):
...
def TVReconCurved(sinogram, geometry, reconstruction_space, lamda, ray_trafo):
    # Initialize gradient operator
    gradient = odl.Gradient(reconstruction_space)
